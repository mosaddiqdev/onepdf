...
export function CustomInstallPrompt() {
    ...
    const handleInstall = useCallback(async () => {
        // For iOS, just close the modal (instructions are already shown)
        if (isIOS) {
            setShowPrompt(false)
            return
        }

        // Need the deferred prompt to install
        if (!deferredPrompt) {
    ...
    const handleShowPrompt = useCallback(() => {
        // Only show if we have a prompt available or it's iOS
    ...
    // Only show if: not dismissed, not showing prompt, and (has deferred prompt OR is iOS)
    ...
    return (
        <>
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="relative bg-linear-to-br from-primary to-primary/90 p-6 text-primary-foreground">
                                ...
                                >
                                    <HugeiconsIcon icon={Cancel01Icon} size={16} className="text-primary-foreground" />
                                </button>

                                <div className="flex items-center gap-4">
                                    <div className="w-12 h-12 rounded-xl flex items-center justify-center overflow-hidden">
                                        <img src="/icons/web-app-manifest-192x192.png" alt="1PDF" className="w-10 h-10" />
                                    </div>
                                    <div>
                                        <h3 className="text-xl font-bold">Install 1PDF</h3>
                                        <p className="text-primary-foreground/80 text-sm">Add to home screen for offline access</p>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="space-y-3">
                                            <div className="flex items-center gap-3 text-sm">
                                                ...
                                                <span className="text-foreground">Tap the <strong>Share</strong> button in Safari</span>
                                            </div>
                                            <div className="flex items-center gap-3 text-sm">
                                            ...
                                            <div className="flex items-center gap-3 text-sm">
                                                ...
                                                <span className="text-foreground">Tap <strong>"Add"</strong> to install</span>
                                            </div>
                                        </div>
                                    </div>
                                ) : (
                                    <div className="space-y-4">
                                        <div className="grid grid-cols-3 gap-3 text-center">
                                            <div className="p-3 bg-muted rounded-lg">
                                                <HugeiconsIcon icon={Lightning} size={24} className="text-primary mx-auto mb-2" />
                                                <p className="text-xs text-muted-foreground">Faster Access</p>
                                            </div>
                                            <div className="p-3 bg-muted rounded-lg">
                                                <HugeiconsIcon icon={Wifi01Icon} size={24} className="text-primary mx-auto mb-2" />
                                                <p className="text-xs text-muted-foreground">Works Offline</p>
                                            </div>
                                            <div className="p-3 bg-muted rounded-lg">
                                                <HugeiconsIcon icon={HardDriveIcon} size={24} className="text-primary mx-auto mb-2" />
                                ...
                                <div className="flex gap-3 mt-6">
                                    ...
                                    >
                                        {isInstalling ? (
                                            ...
                                            <>
                                                <HugeiconsIcon icon={Download01Icon} size={16} className="text-primary-foreground" />
                        ...
                        <div className="bg-white rounded-xl shadow-lg border border-green-200 p-4 max-w-sm">
                            <div className="flex items-center gap-3">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-sm text-muted-foreground">You can now access 1PDF from your home screen.</p>
                                </div>
                            </div>
                        </div>
                    </motion.div>
            ...
            {/* Floating Install Button - Only shows when appropriate */}
            <AnimatePresence>
                {showFloatingButton && (
                    <motion.button
