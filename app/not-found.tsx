...
export default function NotFound() {
  ...
  return (
    <PageTransition>
      <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-background via-background to-muted/20 p-4 sm:p-6 lg:p-8">
        <div className="text-center space-y-6 sm:space-y-8 max-w-sm sm:max-w-md lg:max-w-lg w-full">
          <div className="relative">
            <div className="w-24 h-24 sm:w-32 sm:h-32 lg:w-40 lg:h-40 mx-auto rounded-full bg-linear-to-br from-primary/10 to-primary/5 flex items-center justify-center border border-primary/20">
              <HugeiconsIcon
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <p className="text-sm sm:text-base text-muted-foreground leading-relaxed px-2 sm:px-0">
              <Balancer>
                Oops! The page you&apos;re looking for seems to have vanished like a PDF page in the
                wind. Don&apos;t worry, we&apos;ll help you get back on track.
              </Balancer>
            </p>
          </div>
